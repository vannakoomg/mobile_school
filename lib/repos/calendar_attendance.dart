...
Future fetchCalendarAttendance({required String month, required String year}) async {
  Map<String, String> parameters = {
    'month': month,
    'year': year,
  };
   try{
    String fullUrl = baseUrl_school + getCalendarAttendance;
    ...
    CalendarAttendanceDb calendarAttendanceDb = CalendarAttendanceDb.fromMap(response.data);
