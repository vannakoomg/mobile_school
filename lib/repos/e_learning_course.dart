...
Future fetchELearningCourse({String pageNo = '1', required String courseId, required String category}) async {
  ...
  try{
    String fullUrl = baseUrl_school + getVideoCourseList;
    ...
    ELearningCourseDb eLearningCourseDb = ELearningCourseDb.fromMap(response.data);
